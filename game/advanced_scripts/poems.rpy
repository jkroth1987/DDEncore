...
Not all good times must come to an end."""
    ...
    poem_m_connection = Poem(
    author = "monika",
    title = "Connection",
    text = """\
I found myself standing alone,
Watching connections being made around me.
I stood alone. Disconnected.

Many feelings swept through me,
       if you could even call them feelings.

               Emptiness.
                                    Cold.
                                                       Lifelessness.

When I saw hope in front of me, I felt desperate.
A chance to escape?
A way to heal?
...
I felt a new connection, all my own.
It came to me when I expected it the least.
...
I've begun to see meaning in what looked meaningless.
That maybe my desperation is what was meaningless.

And now that I have this connection,
that I feel such fulfillment because of it
