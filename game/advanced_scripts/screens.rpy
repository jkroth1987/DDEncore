...
style window:
    ...
    background Image("mod_assets/gui/encoretextbox.png", xalign=0.5, yalign=1.0)

style window_monika is window:
    background Image("gui/textbox_monika.png", xalign=0.5, yalign=1.0)

style window_encore is window:
    background Image("mod_assets/gui/encoretextbox.png", xalign=0.5, yalign=1.0)
...
style game_menu_outer_frame:
    ...
    background "mod_assets/gui/menu.png"
...
style game_menu_label_text:
    ...
    size gui.title_text_size
    color "#f2f362"
    outlines [(6, "#b3622c", 0, 0), (3, "#b3622c", 2, 2)]
    yalign 0.5
