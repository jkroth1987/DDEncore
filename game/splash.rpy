...
init python:
    ...
    splash_messages = [
        ...
        "Oki-Doki!",
        "wE rEmOvEd YoUr PoSt bEcAuSe It WoUlDn'T gEt aS mAnY vIeWs- AgentJohn20",
        "Hit or miss, Natsuki's dad never misses!",
        "I dId aLl tHe WoRk On ThIs mOd!- Rose",
...
# The Classic Menu Art sprites. These are here for reference, mainly for positioning.
# Look for the updated menu sprites, which contain full animation code for the opening
# sequence, in menu_sprites.rpy.
#image menu_art_y:
#    subpixel True
#    "gui/menu_art_y.png"
#    xcenter 600
...
label splashscreen:
    ...
    $ config.main_menu_music = audio.f1
