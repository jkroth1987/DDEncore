label encorestart:
    ...
    "I stand up slowly, clutching my forehead in an attempt to nurse this stinging pain."
    ...
    show monika 1a
    mc "M-{w=0.28}Monika?!"
    mc "Where are we? What just happened? Where are the others? W-{w=0.28}what is this?"
    ...
    m 1d "Well, then...{w=0.28} I guess whatever I tried to do must've caused you to forget everything."
    m 2m "I guess my coding skills aren't quite up to scratch."
    mc "Monika, what the hell are you talking about?"
    mc "W-{w=0.28}what \'coding\'? You're not making any sense!"
    m "Oh, dear...{w=0.28} I messed this up pretty badly."
    m 2q "Well, I guess I'll just have to try to take us back, then."
    mc "T-{w=0.28}take us back?? What are you talking about?"
    mc "WHERE ARE YOU TAKING ME?!?"
    m 2e "To the beginning, silly."
    m 2k "You {i}need{/i} to remember something if this going to work."
...
label day1_beginning:
    ...
    "In all the years I've known her, she hasn't changed a bit."
    "Even through the period of time where we drifted apart, it's still good to see that she's the same person."
    "Still, ever since we reconnected and after \'convincing\' me to join the Literature Club, I've still learned some pretty unexpected things about her. "
    "It was only last weekend that I learned about her depression...{w=0.38}and her feelings for me..."
    "So, I decided on that day to tell her how I felt."

    if encore_sayoriquestion_1 == False:
        "I told her that I wanted to help her through this so we can get things back to the way they were."
        ...
        "Even though I know my decision hurt her, I want to try and preserve our friendship, given her current state of mind. At least for right now."
    ...
    "While doing an abridged version of my morning routine, a wave of nostalgia hits me as I think about the club meeting we'll be holding later today."
    "It's hard to believe how invested I've become in the clubsince I first joined..."
    ...
    "Then there was Sayori's confession and the fallout afterwards..."
    "After the festival was over, I was honestly so burnt out that I was tempted to skip the rest of the school week."
    "Still, I think our performances at the festival were okay. We should be getting a few new people at the very least..."
    "Despite having to perform at this year's festival, I certainly had much more fun compared to last year's..."
    ...
    if encore_sayoriquestion_1 == True:
        ...
        "Now, our walks are usually filled with long, uncomfortable silence."
        show sayori 1b
        ...
        mc "Heh, I guess you were right after all, Sayori."
    ...
    "Walking through the mass of other students, I can't help but reminisce at some of the memories I've had with Sayori in these halls."
    ...
    if encore_sayoriquestion_1 == False:
        "I can't help but detect an ounce of hesitation in her voice as she says that."
        "Honestly, I can't really blame her, all things considered..."
        "We're both still trying to figure out how to go about our friendship, and she always seems to be happy when she's around me..."
        "Even despite my rejection of her, she's still willingly hanging around me..."
        "Well, at least our friendship still managed to survive last Sunday..."
    ...
    "Not to mention, we had pretty good turnout for our event. The audience seemed to love our performances."
    ...
    s "That's odd. She's usually here by now."
    show sayori 2g
    ...
    if encore_sayoriquestion_1 == True and encore_festivalquestion_2 == "Natsuki":
        ...
        show natsuki 5q
        "Natsuki audibly gulps, but surprisingly keeps going with what she wants to say..."
        ...
        s 4q "We still get to hang out and have fun, just like we always have!"
...
m 2e "But, I can accept the status quo for now if that's what everyone wants."
show monika 1e
"We all look to each other and nod."
n 4k "Yeah, what we have now is fine...{w=0.38}it's quality over quantity, anyways..."
show natsuki 4a
y 2j "I'm content with our current membership as well..."
show yuri 2a
...
if encore_sayoriquestion_1 == True:
    if encore_festivalquestion_2 == "Natsuki":
        if hangout1 == "Sayori":
            ...
            "Despite the rather interesting exchange that I had with her earlier, she tries to act as if it didn't happen and gives me useful feedback."
            show yuri 1w
            ...
            hide natsuki
            show sayori 1a at t11 zorder 1
            "Sayori's poem was actually rather romantic, something that I wasn't used to seeing her write about."
            "It was about how a girl who finally found someone that's able to make her feel something other than loneliness and depression."
            show sayori u121341
...
if encore_sayoriquestion_1 == False:
    if encore_festivalquestion_2 == "Natsuki":
        if hangout1 == "Sayori":
            ...
            show sayori 1y
            "It was about about two friends, a boy and girl, who had known each other for a long time."
            show sayori 1t
            ...
            "But oddly enough left the door open..."
            show sayori 1k
...
if encore_sayoriquestion_1 == False:
    if encore_festivalquestion_2 == "Yuri":
        if hangout1 == "Natsuki":
            ...
            show natsuki 5p
            "initially, I thought she was just a sour person who didn't want anything to do with me..."
            show natsuki 1z
...
if encore_sayoriquestion_1 == False:
    if encore_festivalquestion_2 == "Natsuki":
        if hangout1 == "Yuri":
            ...
            "Though that didn't stop her from giving me her usual suggestions and encouraged me to experiment more with elaborate language."
            show yuri 1b
            "Our talks of poems quickly shifted to catching up with each other to see how we've been since the festival."
            show yuri 1j
            "During our conversation, we at times struggled to maintain eye contact with each other..."
            ...
            show yuri 4c
            "initially I thought that she'd rather be by herself than be around me..."
            show yuri 1c
...
if encore_sayoriquestion_1 == True:
    if encore_festivalquestion_2 == "Natsuki":
        if hangout1 == "Monika":
            ...
            show monika 5a
            "When we finished sharing, Monika unexpectedly asked me if she could keep my poem!"
...
label day1_clubend:
    ...
    if encore_sayoriquestion_1 == False:
        ...
        s 1a "Same! It feels like the festival was forever ago!"
        ...
        mc "Look, I promised you that nothing would ever change between us and things would be just as they'd always been."
        $ renpy.pause(delay=0.8, hard=True)
        show sayori 1k
        $ renpy.pause(delay=0.8, hard=True)
        show sayori 1v
    ...
    if encore_sayoriquestion_1 == True:
        if encore_festivalquestion_2  == "Natsuki":
            if hangout1 == "Natsuki":
                ...
                "I wonder if it's because of last Sunday when she showed me how to bake those cupcakes?"
    ...
    if encore_sayoriquestion_1 == True:
        if encore_festivalquestion_2  == "Yuri":
            if hangout1 == "Yuri":
                ...
                "I wonder if it's because of last Sunday when we were working on the banner?"
                "I think back to those two times where we almost..."
                "I get butterflies in my stomach just thinking about it!"
                "..."
                "I still need to figure out how to break it to her..."
    ...
    if encore_sayoriquestion_1 == False:
        if encore_festivalquestion_2  == "Natsuki":
            if hangout1 == "Natsuki":
                ...
                "Given everything she's gone through lately, and how I've probably been making things worse..."
    ...
    if encore_sayoriquestion_1 == False:
        if encore_festivalquestion_2  == "Natsuki":
            if hangout1 == "Sayori":
                ...
                "But realistically, I don't think she'd accept a change of heart from me...{w=0.28}especially now..."
    ...
    if encore_sayoriquestion_1 == False:
       if encore_festivalquestion_2  == "Yuri":
           if hangout1 == "Yuri":
               ...
               "I wonder if it's because of that Sunday when we made the banner?"
               "I think back to those two times where we almost..."
    ...
    if encore_sayoriquestion_1 == False:
       if encore_festivalquestion_2  == "Yuri":
           if hangout1 == "Natsuki":
              ...
              "But after she opened up to me a little today, maybe there is a chance after all..."
              "Either way...{w=0.28}sooner or later I'll have to decide who I really want."
              "Oh well, I'm sure it'll be obvious to me soon enough..."
              "As I drift off into sleep, I think to myself..."
              "Life is a funny thing sometimes..."
...
label day1_void:
    ...
    if hangout1 == "Natsuki":
        ...
        "The room shifts towards me every time I unwillingly take another step closer to the closet."
...
label day1_void_monika:
    ...
    if hangout1 == "Monika":
            ...
            m "There's still actually a chance to make things work!"
            ...
            m "They will destroy anything and anyone to get to you."
            m "Such a deplorable, tangled mass is already present in every single one of them."
            m "And my mistake may have set things in motion prematurely."
