...
define config.name = "Doki Doki Encore!"
...
define build.name = "DokiDokiEncore"
...
init python:
    ...
    build.classify('game/Encore!Script.rpy**', "scripts")
    build.classify('game/encore_script-monikaexclusivescenes.rpy**', "scripts")
    build.classify('game/encore_script-natsukiexclusivescenes.rpy**', "scripts")
    build.classify('game/encore_script-natsukiexclusivescenes.rpy**', "scripts")
    build.classify('game/encore_script-sayoriexclusivescenes.rpy**', "scripts")
